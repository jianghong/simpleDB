...
class RBTreeTests(unittest.TestCase):
    ...
    def test_simple_insert(self):
        self.tt.insert('j')
        self.assertEqual(self.tt.root, self.tt.query('j'))
        self.tt.insert('h')
        self.assertEqual(self.tt.root.left, self.tt.query('h'))
        self.tt.insert('k')
        self.assertEqual(self.tt.root.right, self.tt.query('k'))
        self.tt.insert('a')
        self.assertEqual(self.tt.root.left.left, self.tt.query('a'))
        self.tt.insert('z')
        self.assertEqual(self.tt.root.right.right, self.tt.query('z'))
    ...
    def test_left_rotate(self):
        ...
        self.assertEqual(self.tt.root, self.tt.query('a'))
